         ...
         <div class="container">
           ...
           <div class="box">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Favicon</label>
                        <img src="../uploads/identitas/<?= $d->favicon ?>">
                        <input type="hidden" name="favicon_lama" value="<?= $d->favicon ?>" width="32"  class="image">
                    ...
                    <?php
                         ...
                         if(isset($_POST['submit'])){
                          ...
                          if($_FILES['favicon_baru']['name'] !=''){
                            ...
                            move_uploaded_file($tmpname_lfavicon, "../uploads/identitas/".$rename_favicon);
